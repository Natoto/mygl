...
void hbdraw0()
{
  ...
  glEnable(GL_DEPTH_TEST);
    ...
    /*
    offset
    GLfloat offset = glGetUniformLocation(g_shaderObjectProgram,"offset");
...
//    glPolygonMode(GL_FRONT_AND_BACK,GL_LINES);
    ...
    glUniform1i(glGetUniformLocation(g_shaderObjectProgram,"ourTexture1"),0 );
    
    glActiveTexture(GL_TEXTURE1);
    glBindTexture(GL_TEXTURE_2D,g_texture1);
    glUniform1i(glGetUniformLocation(g_shaderObjectProgram,"ourTexture2"),1);
     
    glUniform1f(glGetUniformLocation(g_shaderObjectProgram,"mixvalue"),mixTextureValue);
...
//    trans = glm::rotate(trans, (GLfloat)glfwGetTime() , glm::vec3(0.0f,0.0f,1.0f));
    ...
    GLuint transformLoc = glGetUniformLocation(g_shaderObjectProgram,"transform");
